          ...
          <div class="flex h-16 items-center">
            ...
            <div class="ml-4 flex lg:ml-0">
              <a href="#">
                ...
                <router-link to="/">
                  <img class="h-16 w-auto" src="/blastNode.png" alt=""/>
                </router-link>
              </a>
            </div>
      ...
      featured: [
        {
          name: 'BTC Full Nodes',
          href: '#',
          imageSrc: 'https://www.msamanda0to1.com/wp-content/uploads/2022/01/bg2018010408.png',
          imageAlt: 'Models sitting back to back, wearing Basic Tee in black and bone.',
        },
        {
          name: 'ETH Nodes',
          href: '#',
          imageSrc: 'https://blockgeeks.com/wp-content/uploads/2017/10/ethereumnodesandsharding.jpg',
      ...
      sections: [
        {
          ...
          name: '节点服务',
          items: [
            {name: '节点代跑', href: '#', link: '/projects/blast'},
            {name: '节点咨询', href: '#', link: '/l2'},
            {name: '节点详情', href: '#', link: '/projects/raas'},
          ],
        },
        {
          id: 'accessories',
          name: '热门节点',
          items: [
            {name: 'BTC全节点', href: '#', link: '/insc'},
            {name: 'ETH全节点', href: '#', link: '/insc/btc'},
            {name: 'Monad', href: '#', link: '/hotpoint'},
            {name: 'Taiko', href: '#', link: '/hotpoint'},
          ],
        },
        {
          id: 'brands',
          name: '其他',
          items: [
            {name: '节点管理', href: '#', link: '/eth'},
            {name: '收费咨询', href: '#', link: '/eth'},
            {name: '使用说明', href: '#', link: '/projects/sol'},
            {name: '工具', href: '#', link: '/projects/starknet'},
          ],
        },
      ],
    },
      ...
      featured: [
        {
          name: 'My Nodes',
          href: '#',
          imageSrc: 'https://www.telecomstechnews.com/wp-content/uploads/sites/7/2022/05/cloudflare-ethereum-2-nodes-web3-internet-platform-decentralization-network-the-merge.png',
          imageAlt: 'Models sitting back to back, wearing Basic Tee in black and bone.',
        },
        {
          name: 'Blast',
      ...
      sections: [
        {
          ...
          name: '我的节点',
          items: [
            {name: '我的节点控制台', href: '#', link: '/myNodes'},
            {name: '我的钱包', href: '#', link: '/l2'},
            {name: '我的使用记录', href: '#', link: '/projects/raas'},
            {name: '我的信息', href: '#', link: '/sui'},
          ],
        },
        {
          id: 'accessories',
          name: '管理工具',
          items: [
            {name: '节点监控', href: '#', link: '/insc'},
            {name: '我的门户', href: '#', link: '/insc/btc'},
            {name: '定制服务', href: '#', link: '/hotpoint'},
          ],
        },
      ],
    },
      ...
      sections: [
        {
          ...
          name: '团队',
          items: [
            {name: '团队介绍', link: '/aboutUs'},
            {name: '节点服务介绍', link: '/projects/starknet'},
            {name: '规划', link: '/projects/starknet'},
            {name: '联系方式', link: '/projects/starknet'},
          ],
        },
        {
          id: 'accessories',
          name: '服务收费',
          items: [
            {name: '节点收费标准', link: '/projects/starknet'},
            {name: '活动价格', link: '/projects/starknet'},
            {name: '咨询服务价格', link: '/projects/starknet'},
          ],
        },
      ],
    },
